...
class ApisControllerTest < ActionController::TestCase
  ...
  test "should create api" do
    assert_difference('Api.count') do
      post :create, api: { body: @api.body, memo: @api.memo, name: @api.name, page_type: @api.page_type }
    end
  ...
  test "should update api" do
    patch :update, id: @api, api: { body: @api.body, memo: @api.memo, name: @api.name, page_type: @api.page_type }
    assert_redirected_to api_path(assigns(:api))
  end
